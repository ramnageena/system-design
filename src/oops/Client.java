...
/**
 * Simple client/demo class to exercise the {@link PaymentService} and
 * various {@link PaymentMethod} implementations.
 */
public class Client {
    public static void main(String[] args) {
        ...
        ps.addPaymentMethod("Ram's debit card", new DebitCard("Ram Tiwari", "875478445252", 258));
